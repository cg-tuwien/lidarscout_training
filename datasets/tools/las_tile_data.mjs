...
async function processLas(file, outPath, outCSV){
    ...
    if(header.format === 8) rgbOffset = 30;
...
//let dir = "E:/datasets/point_clouds/CA13_SAN_SIM_las";
let dir = "E:/datasets/point_clouds/NZ23_Gisborne_subsets/BF44_las";
//let dir = "E:/datasets/point clouds/swisssurface3d_uncomp";
// let dir = "E:/datasets/point clouds/AHN5_las";
let files = fs.readdirSync(dir);
// let files = fs.readdirSync("E:/resources/pointclouds/CA13_las");

let outCSV = "./chunkPoints_BF44.csv";
// console.log(files);
